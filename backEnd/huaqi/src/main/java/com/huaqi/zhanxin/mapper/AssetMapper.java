...
public interface AssetMapper {
    ...
    int insertAsset(@Param("userID") int userID, @Param("bank") String bank, @Param("money") int money,
                    @Param("addTime") Timestamp addTime);
    ...
    int updateAsset(@Param("userID") int userID, @Param("bank") String bank, @Param("money") int money,
                    @Param("addTime") Timestamp addTime);
}
