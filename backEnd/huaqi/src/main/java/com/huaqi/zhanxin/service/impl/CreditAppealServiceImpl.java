...
public class CreditAppealServiceImpl implements CreditAppealService {
    ...
    @Override
    public int insertAppeal(int userID, Timestamp appealTime, String reason, String question, String require,
                            int appealState) {
    ...
    public List<JSONObject> getAppealList(String type, Integer pageNum, Integer pageSize) {
        if (Objects.equals(type, "all")) {
            ...
            return creditAppealMapper.selectAllByType(type, pageNum, pageSize);
        }
    }

    @Override
    public Integer judgeAppeal(Integer user_id, Timestamp appeal_time, String type, String detail, Double value,
                               Integer state) {
