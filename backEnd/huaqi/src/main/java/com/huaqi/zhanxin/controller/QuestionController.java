...
public class QuestionController {
    ...
    public Result<?> addQuestion(@RequestParam("video_id") Integer video_id,
    ...
    public Map<String, Object> submitQuestion(HttpServletRequest request,Integer video_id, Integer watch,
                                              Integer score) {
